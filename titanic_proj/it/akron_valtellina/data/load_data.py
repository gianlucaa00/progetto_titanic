...
class Dataset:
    def __init__(self, source='uci', dataset_id=73, csv_path=None, target_column=None, is_test = False):
        """
    ...
    def __load_test_csv(self):
        ...
        self.__test = pd.read_csv(self.__csv_path)

    def get_test(self):
        """Restituisce test originale"""
        return self.__test
